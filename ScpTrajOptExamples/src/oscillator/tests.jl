...
if isdefined(@__MODULE__, :LanguageServer)
    ...
    include("../../../ScpTrajOptParser/src/problem.jl")
...
function ptr()::Nothing
    ...
    pars = ScpTrajOptSolvers.PTR.Parameters(
        N, Nsub, iter_max, wvc, wtr, ε_abs, ε_rel, feas_tol,
    ...
    ptr_pbm = ScpTrajOptSolvers.PTR.create(pars, pbm)
    sols, historys = [], []
    for i = 1:Nhom
        ...
        sol_i, history_i = ScpTrajOptSolvers.PTR.solve(ptr_pbm, warm)
