...
# ax.plot(pdg.t,pdg.r[1,:],color="red",linestyle="none",marker=".",
#         markersize=5)
# ax.plot(t,r[2,:],color="green",label="y")
# ax.plot(pdg.t,pdg.r[2,:],color="green",linestyle="none",marker=".",
#         markersize=5)
# ax.plot(t,r[3,:],color="blue",label="z")
# ax.plot(pdg.t,pdg.r[3,:],color="blue",linestyle="none",marker=".",
#         markersize=5)
# plt.legend()
# ax.set_xlabel("Time [s]")
...
# ax.plot(pdg.t,pdg.v[1,:],color="red",linestyle="none",marker=".",
#         markersize=5)
# ax.plot(t,v[2,:],color="green",label="y")
# ax.plot(pdg.t,pdg.v[2,:],color="green",linestyle="none",marker=".",
#         markersize=5)
# ax.plot(t,v[3,:],color="blue",label="z")
# ax.plot(pdg.t,pdg.v[3,:],color="blue",linestyle="none",marker=".",
#         markersize=5)
# plt.legend()
# ax.set_xlabel("Time [s]")
...
# ax.plot(pdg.t,pdg.m,color="black",linestyle="none",marker=".",
#         markersize=5)
# ax.set_xlabel("Time [s]")
# ax.set_ylabel("Mass [kg]")
# # >> Thrust <<
...
# # ax.plot(pdg.t[1:end-1],pdg.T[1,:],color="red",linestyle="none",marker=".",
# #         markersize=5)
# # ax.plot(t,T[2,:],color="green",label="y")
# # ax.plot(pdg.t[1:end-1],pdg.T[2,:],color="green",linestyle="none",marker=".",
# #         markersize=5)
# # ax.plot(t,T[3,:],color="blue",label="z")
# # ax.plot(pdg.t[1:end-1],pdg.T[3,:],color="blue",linestyle="none",marker=".",
# #         markersize=5)
# ax.plot(pdg.t[1:end-1],pdg.T_nrm,color="black",linestyle="none",marker=".",
#         markersize=5)
