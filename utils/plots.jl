#= Plotting functions used for computed trajectory visualization.
...
function setup_axis!(ijk::T_Int; kwargs...)::PyPlot.PyObject
...
"""
function generate_colormap(style::T_String="inferno_r";
                           minval::T_Real=0.0,
                           maxval::T_Real=1.0,
                           midval::T_Real=NaN)::PyPlot.PyObject
...
"""
function rgb(cmap::PyPlot.PyObject, v::T_Real)::Tuple{T_Real, T_Real, T_Real}
